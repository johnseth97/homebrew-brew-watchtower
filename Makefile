...
install: test
	...
	@sed 's/brew-watchtower/$(DEV_NAME)/g' completions/brew-watchtower.bash > "$(DEV_ROOT)/share/bash-completion/completions/$(DEV_NAME)"
	@sed 's/brew-watchtower/$(DEV_NAME)/g' completions/_brew-watchtower > "$(DEV_ROOT)/share/zsh/site-functions/_$(DEV_NAME)"
